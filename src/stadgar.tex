...
\para [Fri nominering] Datateknologer ska inkomma med nomineringar och motnomineringar till valberedningen.
...
\para [Ranked Choice Voting] Vid Ranked Choice Voting ska varje röstberättigad fylla i en valsedel och rangordna samtliga sökande efter preferens med den mest lämpliga kandidaten först.
